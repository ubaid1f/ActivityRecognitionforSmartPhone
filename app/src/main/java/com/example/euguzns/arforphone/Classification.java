...
public class Classification {
    ...
    public Classification(String filename, int FEATURES_NUM, String[] label, Classifier classifier) {
        try {
    ...
    private Instance createInstance(Instances associatedDataSet,
        ...
        Instance instance = new DenseInstance(FEATURES_NUM + 1);
